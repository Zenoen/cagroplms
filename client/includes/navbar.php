<nav class="navbar navbar-expand-md navbar-light sticky-top bg-transparent" id="nav">
    <div class="d-flex w-100 align-items-center">
        ...
        <a href="#" class="navbar-brand me-2">
            <div class="d-flex align-items-center pe-3 rounded-pill">
                ...
                $formatted = str_replace(
                    ...
                    ['Permit • Fisher Folks', 'Permit • Fish Workers', 'Permit • Fishing Gears', 'Permit • Fishing Cages', 'Permit • Fishing Boats'],
                    $_GET['page']
                );
                ?>
        ...
        <div class="d-flex w-100  justify-content-end align-items-center">
            ...
            <?php
            $notifCounter = $conn->query("SELECT COUNT(*) AS total FROM `notifications` WHERE not_status = 0 AND not_for='client'  AND not_client_email='".$_SESSION['user']."'");
            ...
            <div class="dropdown pe-3 ">
                ...
                <span class="w-100 fs-6 p-2"></span>
                    ...
                    <div class="overflow-auto" style="max-height: 500px;">
                        ...
                        $sql = "SELECT * FROM notifications WHERE  not_for='client' AND not_client_email='".$_SESSION['user']."' ORDER BY  not_id DESC LIMIT 10  ";
                        ...
                        ?>
                                <li>
                                    ...
                                    $page = str_replace(
                                        ...
                                        ["fishingcages", "fishworkers", "fishingboats", "fishinggears", "fishworkerlicenses"],
                                        $row["row_type"]
                                    )
                                    ?>
